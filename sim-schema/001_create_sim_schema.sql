...
-- =============================================================
-- TRACEABILITY: Add simulator fields to Haven issues table
-- Run this in the SIMULATOR Supabase project's issues table
-- =============================================================
alter table issues
...
add column if not exists test_condition 	text check (test_condition in
('baseline','haven')),
